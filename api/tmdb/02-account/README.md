...
- `avatar` — object — 
  - `gravatar` — object — 
    - `hash` — string —  (ตัวอย่าง: `"c9e9fc152ee756a900db85757c29815d"`)
  - `tmdb` — object — 
    - `avatar_path` — string —  (ตัวอย่าง: `"/xy44UvpbTgzs9kWmp4C3fEaCl5h.png"`)
- `id` — integer —  (ตัวอย่าง: `548`)
- `iso_639_1` — string —  (ตัวอย่าง: `"en"`)
- `iso_3166_1` — string —  (ตัวอย่าง: `"CA"`)
- `name` — string —  (ตัวอย่าง: `"Travis Bell"`)
- `include_adult` — boolean —  (ตัวอย่าง: `false`)
- `username` — string —  (ตัวอย่าง: `"travisbell"`)

---

### `GET /3/account/{account_id}/favorite/movies`

> สรุป: Favorite Movies
...
- `results` — array — 
  ...
  - `backdrop_path` — string —  (ตัวอย่าง: `"/se5Hxz7PArQZOG3Nx2bpfOhLhtV.jpg"`)
  - `genre_ids` — array — 
  - `id` — integer —  (ตัวอย่าง: `9806`)
  - `original_language` — string —  (ตัวอย่าง: `"en"`)
  - `original_title` — string —  (ตัวอย่าง: `"The Incredibles"`)
  - `overview` — string —  (ตัวอย่าง: `"Bob Parr has given up his superhero days to log in time as an insurance adjuster and raise his three children with his formerly heroic wife in suburbia. But when he receives a mysterious assignment, it's time to get back into costume."`)
  - `popularity` — number —  (ตัวอย่าง: `71.477`)
  - `poster_path` — string —  (ตัวอย่าง: `"/2LqaLgk4Z226KkgPJuiOQ58wvrm.jpg"`)
  - `release_date` — string —  (ตัวอย่าง: `"2004-10-27"`)
  - `title` — string —  (ตัวอย่าง: `"The Incredibles"`)
  - `video` — boolean —  (ตัวอย่าง: `false`)
  - `vote_average` — number —  (ตัวอย่าง: `7.702`)
  - `vote_count` — integer —  (ตัวอย่าง: `16162`)
- `total_pages` — integer —  (ตัวอย่าง: `4`)
- `total_results` — integer —  (ตัวอย่าง: `80`)
...
- `results` — array — 
  ...
  - `vote_count` — integer —  (ตัวอย่าง: `11548`)
- `total_pages` — integer —  (ตัวอย่าง: `4`)
- `total_results` — integer —  (ตัวอย่าง: `68`)
...
- `results` — array — 
  ...
  - `id` — integer —  (ตัวอย่าง: `120174`)
  - `item_count` — integer —  (ตัวอย่าง: `5`)
  - `iso_639_1` — string —  (ตัวอย่าง: `"en"`)
  - `list_type` — string —  (ตัวอย่าง: `"movie"`)
  - `name` — string —  (ตัวอย่าง: `"Test Alpha Sort"`)
  - `poster_path` — object — 
- `total_pages` — integer —  (ตัวอย่าง: `2`)
- `total_results` — integer —  (ตัวอย่าง: `25`)
...
- `results` — array — 
  - `[]` — array items: — 
  - `adult` — boolean —  (ตัวอย่าง: `false`)
  - `backdrop_path` — string —  (ตัวอย่าง: `"/dUVbWINfRMGojGZRcO6GF1Z2nV8.jpg"`)
  - `genre_ids` — array — 
  - `id` — integer —  (ตัวอย่าง: `120`)
  - `original_language` — string —  (ตัวอย่าง: `"en"`)
  - `original_title` — string —  (ตัวอย่าง: `"The Lord of the Rings: The Fellowship of the Ring"`)
  - `overview` — string —  (ตัวอย่าง: `"Young hobbit Frodo Baggins, after inheriting a mysterious ring from his uncle Bilbo, must leave his home in order to keep it from falling into the hands of its evil creator. Along the way, a fellowship is formed to protect the ringbearer and make sure that the ring arrives at its final destination: Mt. Doom, the only place where it can be destroyed."`)
  - `popularity` — number —  (ตัวอย่าง: `84.737`)
  - `poster_path` — string —  (ตัวอย่าง: `"/6oom5QYQ2yQTMJIbnvbkBL9cHo6.jpg"`)
  - `release_date` — string —  (ตัวอย่าง: `"2001-12-18"`)
  - `title` — string —  (ตัวอย่าง: `"The Lord of the Rings: The Fellowship of the Ring"`)
  - `video` — boolean —  (ตัวอย่าง: `false`)
  - `vote_average` — number —  (ตัวอย่าง: `8.396`)
  - `vote_count` — integer —  (ตัวอย่าง: `22579`)
  - `rating` — integer —  (ตัวอย่าง: `8`)
- `total_pages` — integer —  (ตัวอย่าง: `47`)
- `total_results` — integer —  (ตัวอย่าง: `940`)
...
- `results` — array — 
  - `[]` — array items: — 
  - `adult` — boolean —  (ตัวอย่าง: `false`)
  - `backdrop_path` — string —  (ตัวอย่าง: `"/2yZXtM2Kky1Sy0kachbDlwybl3y.jpg"`)
  - `genre_ids` — array — 
  - `id` — integer —  (ตัวอย่าง: `1705`)
  - `origin_country` — array — 
  - `original_language` — string —  (ตัวอย่าง: `"en"`)
  - `original_name` — string —  (ตัวอย่าง: `"Fringe"`)
  - `overview` — string —  (ตัวอย่าง: `"FBI Special Agent Olivia Dunham, brilliant but formerly institutionalized scientist Walter Bishop and his scheming, reluctant son Peter uncover a deadly mystery involving a series of unbelievable events and realize they may be a part of a larger, more disturbing pattern that blurs the line between science fiction and technology."`)
  - `popularity` — number —  (ตัวอย่าง: `151.906`)
  - `poster_path` — string —  (ตัวอย่าง: `"/sY9hg5dLJ93RJOyKEiu1nAtBRND.jpg"`)
  - `first_air_date` — string —  (ตัวอย่าง: `"2008-09-09"`)
  - `name` — string —  (ตัวอย่าง: `"Fringe"`)
  - `vote_average` — number —  (ตัวอย่าง: `8.109`)
  - `vote_count` — integer —  (ตัวอย่าง: `2050`)
  - `rating` — integer —  (ตัวอย่าง: `9`)
- `total_pages` — integer —  (ตัวอย่าง: `15`)
- `total_results` — integer —  (ตัวอย่าง: `290`)
...
- `results` — array — 
  - `[]` — array items: — 
  - `air_date` — string —  (ตัวอย่าง: `"2013-10-17"`)
  - `episode_number` — integer —  (ตัวอย่าง: `5`)
  - `id` — integer —  (ตัวอย่าง: `64782`)
  - `name` — string —  (ตัวอย่าง: `"The Workplace Proximity"`)
  - `overview` — string —  (ตัวอย่าง: `"Amy starts working at Caltech which causes friction with Sheldon. Howard agrees with Sheldon who mentions this to Bernadette causing a big fight for the Wolowitzes."`)
  - `production_code` — string —  (ตัวอย่าง: `"4X5305"`)
  - `runtime` — integer —  (ตัวอย่าง: `22`)
  - `season_number` — integer —  (ตัวอย่าง: `7`)
  - `show_id` — integer —  (ตัวอย่าง: `1418`)
  - `still_path` — string —  (ตัวอย่าง: `"/k8atjbd5gAsntuhbPnFpvnvo0qn.jpg"`)
  - `vote_average` — number —  (ตัวอย่าง: `7.242`)
  - `vote_count` — integer —  (ตัวอย่าง: `31`)
  - `rating` — integer —  (ตัวอย่าง: `8`)
- `total_pages` — integer —  (ตัวอย่าง: `10`)
- `total_results` — integer —  (ตัวอย่าง: `186`)

---

### `GET /3/account/{account_id}/watchlist/movies`

> สรุป: Watchlist Movies
...
- `results` — array — 
  - `[]` — array items: — 
  - `adult` — boolean —  (ตัวอย่าง: `false`)
  - `backdrop_path` — string —  (ตัวอย่าง: `"/rgNzvSagnlc32TuMEBa529QFIig.jpg"`)
  - `genre_ids` — array — 
  - `id` — integer —  (ตัวอย่าง: `76726`)
  - `original_language` — string —  (ตัวอย่าง: `"en"`)
  - `original_title` — string —  (ตัวอย่าง: `"Chronicle"`)
  - `overview` — string —  (ตัวอย่าง: `"Three high school students make an incredible discovery, leading to their developing uncanny powers beyond their understanding. As they learn to control their abilities and use them to their advantage, their lives start to spin out of control, and their darker sides begin to take over."`)
  - `popularity` — number —  (ตัวอย่าง: `37.148`)
  - `poster_path` — string —  (ตัวอย่าง: `"/xENglsVIIWEEhhB5lgpy33tGcKI.jpg"`)
  - `release_date` — string —  (ตัวอย่าง: `"2012-02-01"`)
  - `title` — string —  (ตัวอย่าง: `"Chronicle"`)
  - `video` — boolean —  (ตัวอย่าง: `false`)
  - `vote_average` — number —  (ตัวอย่าง: `6.822`)
  - `vote_count` — integer —  (ตัวอย่าง: `4741`)
- `total_pages` — integer —  (ตัวอย่าง: `34`)
- `total_results` — integer —  (ตัวอย่าง: `677`)
...
```json
{
  ...
  "results": [
    ...
    {
      "adult": false,
      "backdrop_path": "/o1kYeMsqlVs9xTjJTOnYnoHfMiD.jpg",
      "genre_ids": [
        18,
        9648,
        10765
      ...
      "popularity": 40.923,
      "poster_path": "/ooDWFmGR5foBvLNsX1t30Kv6Dlc.jpg",
    ...
    {
      "adult": false,
      "backdrop_path": "/rFndH81vGRQeQHEhQFkFRqXB0tK.jpg",
      "genre_ids": [
        18
      ],
      "id": 58928,
      ...
      "overview": "It's the late 19th century, and the mysterious Dracula has arrived in London, posing as an American entrepreneur who wants to bring modern science to Victorian society. He's especially interested in the new technology of electricity, which promises to brighten the night - useful for someone who avoids the sun. But he has another reason for his travels: he hopes to take revenge on those who cursed him with immortality centuries earlier. Everything seems to be going according to plan... until he becomes infatuated with a woman who appears to be a reincarnation of his dead wife.",
      "popularity": 17.511,
      "poster_path": "/oQUU8LKVl10ejpxJC0qfsSuPZeF.jpg",
    ...
    },
    {
      ...
      "original_language": "en",
      "original_name": "How TV Ruined Your Life",
      "overview": "How TV Ruined Your Life is a six-episode BBC Two television series written and presented by Charlie Brooker. Charlie Brooker, whose earlier TV-related programmes include How to Watch Television, Charlie Brooker's Screenwipe and You Have Been Watching, examines how the medium has bent reality to fit its own ends. Produced by Zeppotron, the series aired its first episode in January 2011.",
      "popularity": 2.487,
      "poster_path": "/7Jf1O7Hna6nPjBpfu1biqpMsDjI.jpg",
      "first_air_date": "2011-01-25",
    ...
    {
      "adult": false,
      "backdrop_path": "/iWDs7D8PSRcstLFuQf7uwGjBB89.jpg",
      "genre_ids": [
        80,
        18,
        9648
    ...
    {
      "adult": false,
      "backdrop_path": "/9hnNK78pwhTJjNygIFW4t2OcfZv.jpg",
      "genre_ids": [
        35
      ],
      "id": 32406,
    ...
    {
      "adult": false,
      "backdrop_path": "/aGCq8HHRg65MUmP9Gb6MeoJDXrD.jpg",
      "genre_ids": [
        35
      ],
      "id": 58942,
    ...
    {
      "adult": false,
      "backdrop_path": "/qzBaQAhGk5Rp08KX7EUTSVia6bZ.jpg",
      "genre_ids": [
        35
      ],
      "id": 51320,
      ...
      "popularity": 7.507,
      "poster_path": "/y3d7thiGCbYfFCJfKNyVX9GrqQo.jpg",
    ...
    {
      "adult": false,
      "backdrop_path": "/nywPcsxgt1PdEG7BqUYBIUTPNGx.jpg",
      "genre_ids": [
        18
      ],
      "id": 44840,
      ...
      "overview": "The true story of a decades-long conflict between the Los Angeles Police Department, under the determined leadership of Police Chief William Parker, and ruthless criminal elements led by Mickey Cohen, a one-time boxer who rose to the top of L.A.'s criminal world. The series is a fast-paced crime drama set in Los Angeles during the 1940s and '50s. It's a world of glamorous movie stars, powerful studio heads, returning war heroes, a powerful and corrupt police force and an even more dangerous criminal network determined to make L.A. its West Coast base.",
      "popularity": 6.096,
      "poster_path": "/6W6Xhj1KOIcBtASHHhmpyySoUik.jpg",
    ...
    {
      "adult": false,
      "backdrop_path": "/g61rFsbIVoN8tb08nChex1FERQu.jpg",
      "genre_ids": [
        18
      ],
      "id": 32940,
    ...
    {
      "adult": false,
      "backdrop_path": "/qPvvbMIe8pOHGQ0e8bq1Ely7qGL.jpg",
      "genre_ids": [
        18,
        10759
      ],
      ...
      "popularity": 45.283,
      "poster_path": "/rFy3EOZrRymjkalih7W3v8kSVWr.jpg",
...
- `results` — array — 
  - `[]` — array items: — 
  - `adult` — boolean —  (ตัวอย่าง: `false`)
  - `backdrop_path` — string —  (ตัวอย่าง: `"/7phlGHRupo38EnuwmkAHdNUqov3.jpg"`)
  - `genre_ids` — array — 
  - `id` — integer —  (ตัวอย่าง: `58932`)
  - `origin_country` — array — 
  - `original_language` — string —  (ตัวอย่าง: `"en"`)
  - `original_name` — string —  (ตัวอย่าง: `"The Crazy Ones"`)
  - `overview` — string —  (ตัวอย่าง: `"The Crazy Ones is an American situation comedy series created by David E. Kelley that stars Robin Williams and Sarah Michelle Gellar. The single-camera project premiered on CBS on September 26, 2013, as part of the 2013–14 American television season as a Thursday night 9 pm entry. Bill D'Elia, Dean Lorey, Jason Winer, John Montgomery and Mark Teitelbaum serve as executive producers for 20th Century Fox Television."`)
  - `popularity` — number —  (ตัวอย่าง: `8.939`)
  - `poster_path` — string —  (ตัวอย่าง: `"/s2e7hTrdmNUaJDf0yDP5b4AHvrD.jpg"`)
  - `first_air_date` — string —  (ตัวอย่าง: `"2013-09-26"`)
  - `name` — string —  (ตัวอย่าง: `"The Crazy Ones"`)
  - `vote_average` — number —  (ตัวอย่าง: `6.176`)
  - `vote_count` — integer —  (ตัวอย่าง: `94`)
- `total_pages` — integer —  (ตัวอย่าง: `17`)
- `total_results` — integer —  (ตัวอย่าง: `325`)
