...
- `certifications` — object — 
  - `AU` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"E"`)
    - `meaning` — string —  (ตัวอย่าง: `"Exempt from classification. Films that are exempt from classification must not contain contentious material (i.e. material that would ordinarily be rated M or higher)."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `BG` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"D"`)
    - `meaning` — string —  (ตัวอย่าง: `"Prohibited for persons under 16."`)
    - `order` — integer —  (ตัวอย่าง: `4`)
  - `BR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"14"`)
    - `meaning` — string —  (ตัวอย่าง: `"Not recommended for minors under fourteen. More violent material, stronger sex references and/or nudity."`)
    - `order` — integer —  (ตัวอย่าง: `4`)
  - `CA` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
    - `meaning` — string —  (ตัวอย่าง: `"All ages."`)
    - `order` — integer —  (ตัวอย่าง: `2`)
  - `CA-QC` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"NR"`)
    - `meaning` — string —  (ตัวอย่าง: `"No rating information."`)
    - `order` — integer —  (ตัวอย่าง: `0`)
  - `DE` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"12"`)
    - `meaning` — string —  (ตัวอย่าง: `"Children 12 or older admitted, children between 6 and 11 only when accompanied by parent or a legal guardian."`)
    - `order` — integer —  (ตัวอย่าง: `3`)
  - `DK` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"NR"`)
    - `meaning` — string —  (ตัวอย่าง: `"No rating information."`)
  ...
  - `ES` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"A"`)
    - `meaning` — string —  (ตัวอย่าง: `"General admission."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `FI` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"K-16"`)
    - `meaning` — string —  (ตัวอย่าง: `"Over 16 years."`)
    - `order` — integer —  (ตัวอย่าง: `4`)
  - `FR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"TP"`)
    - `meaning` — string —  (ตัวอย่าง: `"Valid for all audiences."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `GB` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"15"`)
    - `meaning` — string —  (ตัวอย่าง: `"Only those over 15 years are admitted. Nobody younger than 15 can rent or buy a 15-rated VHS, DVD, Blu-ray Disc, UMD or game, or watch a film in the cinema with this rating. Films under this category can contain adult themes, hard drugs, frequent strong language and limited use of very strong language, strong violence and strong sex references, and nudity without graphic detail. Sexual activity may be portrayed but without any strong detail. Sexual violence may be shown if discreet and justified by context."`)
    - `order` — integer —  (ตัวอย่าง: `5`)
  - `HU` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"6"`)
    - `meaning` — string —  (ตัวอย่าง: `"Not recommended below age of 6."`)
    - `order` — integer —  (ตัวอย่าง: `2`)
  - `IN` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"U"`)
    - `meaning` — string —  (ตัวอย่าง: `"Unrestricted Public Exhibition throughout India, suitable for all age groups. Films under this category should not upset children over 4. Such films may contain educational, social or family-oriented themes. Films under this category may also contain fantasy violence and/or mild bad language."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `IT` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"NR"`)
  ...
  - `NL` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"AL"`)
    - `meaning` — string —  (ตัวอย่าง: `"All ages."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `NO` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"6"`)
    - `meaning` — string —  (ตัวอย่าง: `"6 years (no restriction for children accompanied by an adult)."`)
    - `order` — integer —  (ตัวอย่าง: `2`)
  - `NZ` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
    - `meaning` — string —  (ตัวอย่าง: `"Suitable for general audiences."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `PH` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"NR"`)
  ...
  - `PT` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"Públicos"`)
    - `meaning` — string —  (ตัวอย่าง: `"For all the public (especially designed for children under 3 years of age)."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `RU` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"6+"`)
    - `meaning` — string —  (ตัวอย่าง: `"(For children above 6) – Unsuitable for children under 6."`)
    - `order` — integer —  (ตัวอย่าง: `2`)
  - `SE` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"11"`)
    - `meaning` — string —  (ตัวอย่าง: `"Children over the age of 7, who are accompanied by an adult, are admitted to films that have been passed for children from the age of 11."`)
    - `order` — integer —  (ตัวอย่าง: `3`)
  - `US` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"R"`)
    - `meaning` — string —  (ตัวอย่าง: `"Under 17 requires accompanying parent or adult guardian 21 or older. The parent/guardian is required to stay with the child under 17 through the entire movie, even if the parent gives the child/teenager permission to see the film alone. These films may contain strong profanity, graphic sexuality, nudity, strong violence, horror, gore, and strong drug use. A movie rated R for profanity often has more severe or frequent language than the PG-13 rating would permit. An R-rated movie may have more blood, gore, drug use, nudity, or graphic sexuality than a PG-13 movie would admit."`)
    - `order` — integer —  (ตัวอย่าง: `4`)
  - `KR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"All"`)
    - `meaning` — string —  (ตัวอย่าง: `"Film suitable for all ages."`)
    - `order` — integer —  (ตัวอย่าง: `0`)
  - `SK` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"U"`)
    - `meaning` — string —  (ตัวอย่าง: `"General audience."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `TH` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"P"`)
    - `meaning` — string —  (ตัวอย่าง: `"Educational."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `MX` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"AA"`)
    - `meaning` — string —  (ตัวอย่าง: `"Informative-only rating: Understandable for children under 7 years."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `ID` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"SU"`)
    - `meaning` — string —  (ตัวอย่าง: `"All ages."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `TR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"Genel İzleyici Kitlesi"`)
    - `meaning` — string —  (ตัวอย่าง: `"General audience."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `AR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"ATP"`)
    - `meaning` — string —  (ตัวอย่าง: `"For all public."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `GR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"K"`)
    - `meaning` — string —  (ตัวอย่าง: `"No restrictions."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `TW` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"0+"`)
    - `meaning` — string —  (ตัวอย่าง: `"Viewing is permitted for audiences of all ages."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `ZA` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"A"`)
    - `meaning` — string —  (ตัวอย่าง: `"Suitable for all."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `SG` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
    - `meaning` — string —  (ตัวอย่าง: `"Suitable for all ages."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `IE` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
    - `meaning` — string —  (ตัวอย่าง: `"Suitable for children of school going age (note: children can be enrolled in school from the age of 4)."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `PR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
    - `meaning` — string —  (ตัวอย่าง: `""`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `JP` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
    - `meaning` — string —  (ตัวอย่าง: `"General, suitable for all ages."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `VI` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
    - `meaning` — string —  (ตัวอย่าง: `"All ages admitted."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `CH` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"0"`)
  ...
  - `HK` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"I"`)
    - `meaning` — string —  (ตัวอย่าง: `""`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `MO` — array — 
    - `[]` — array items: — 
  ...
  - `LU` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"EA"`)
    - `meaning` — string —  (ตัวอย่าง: `""`)
    - `order` — integer —  (ตัวอย่าง: `1`)
...
- `certifications` — object — 
  - `AU` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"P"`)
    - `meaning` — string —  (ตัวอย่าง: `"Programming is intended for younger children 2–11; commercial stations must show at least 30 minutes of P-rated content each weekday and weekends at all times. No advertisements may be shown during P-rated programs."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `BR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"14"`)
    - `meaning` — string —  (ตัวอย่าง: `"Content suitable for viewers over the age of 14."`)
    - `order` — integer —  (ตัวอย่าง: `3`)
  - `CA` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"Exempt"`)
    - `meaning` — string —  (ตัวอย่าง: `"Shows which are exempt from ratings (such as news and sports programming) will not display an on-screen rating at all."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `CA-QC` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"18+"`)
    - `meaning` — string —  (ตัวอย่าง: `"Only to be viewed by adults and may contain extreme violence and graphic sexual content. It is mostly used for 18+ movies and pornography."`)
    - `order` — integer —  (ตัวอย่าง: `5`)
  - `DE` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"0"`)
    - `meaning` — string —  (ตัวอย่าง: `"Can be aired at any time."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `ES` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"NR"`)
  ...
  - `GB` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"U"`)
    - `meaning` — string —  (ตัวอย่าง: `"The U symbol stands for Universal. A U film should be suitable for audiences aged four years and over."`)
    - `order` — integer —  (ตัวอย่าง: `0`)
  - `HU` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"Unrated"`)
    - `meaning` — string —  (ตัวอย่าง: `"Without age restriction."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `KR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"Exempt"`)
    - `meaning` — string —  (ตัวอย่าง: `"This rating is only for knowledge based game shows; lifestyle shows; documentary shows; news; current topic discussion shows; education/culture shows; sports that excludes MMA or other violent sports; and other programs that Korea Communications Standards Commission recognizes."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `LT` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"S"`)
    - `meaning` — string —  (ตัวอย่าง: `"Intended for adult viewers from the age of 18 (corresponding to the age-appropriate index N-18) and broadcast between 23 (11pm) and 6 (6am) hours; Limited to minors and intended for adult audiences."`)
    - `order` — integer —  (ตัวอย่าง: `3`)
  - `NL` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"NR"`)
  ...
  - `PT` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"12AP"`)
    - `meaning` — string —  (ตัวอย่าง: `"Acompanhamento Parental (may not be suitable for children under 12, parental guidance advised)."`)
    - `order` — integer —  (ตัวอย่าง: `3`)
  - `RU` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"16+"`)
    - `meaning` — string —  (ตัวอย่าง: `"Only teens the age of 16 or older can watch."`)
    - `order` — integer —  (ตัวอย่าง: `4`)
  - `SK` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"NR"`)
  ...
  - `TH` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"ส"`)
    - `meaning` — string —  (ตัวอย่าง: `"Sor - Educational movies which the public should be encouraged to see."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `US` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"TV-MA"`)
    - `meaning` — string —  (ตัวอย่าง: `"This program is specifically designed to be viewed by adults and therefore may be unsuitable for children under 17."`)
    - `order` — integer —  (ตัวอย่าง: `6`)
  - `IT` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"T"`)
    - `meaning` — string —  (ตัวอย่าง: `"All ages admitted."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `FI` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"S"`)
    - `meaning` — string —  (ตัวอย่าง: `"Allowed at all times."`)
    - `order` — integer —  (ตัวอย่าง: `0`)
  - `MY` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"U"`)
    - `meaning` — string —  (ตัวอย่าง: `"No age limit. Can be broadcast anytime."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `NZ` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
    - `meaning` — string —  (ตัวอย่าง: `"Approved for general viewing."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `NO` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"A"`)
  ...
  - `BG` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"Unrated"`)
    - `meaning` — string —  (ตัวอย่าง: `"Can be viewed for each age."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `MX` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"AA"`)
    - `meaning` — string —  (ตัวอย่าง: `"Aimed at children (can be broadcast anytime)."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `IN` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"U"`)
    - `meaning` — string —  (ตัวอย่าง: `"Viewable for all ages."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `DK` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"A"`)
    - `meaning` — string —  (ตัวอย่าง: `"Suitable for a general audience."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `SE` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"Btl"`)
    - `meaning` — string —  (ตัวอย่าง: `""`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `ID` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"SU"`)
    - `meaning` — string —  (ตัวอย่าง: `"Suitable for general audiences over the age of 2 years."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `TR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"Genel İzleyici"`)
    - `meaning` — string —  (ตัวอย่าง: `"General audience. Suitable for all ages."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `AR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"ATP"`)
    - `meaning` — string —  (ตัวอย่าง: `"Suitable for all audiences."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `PL` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"0"`)
    - `meaning` — string —  (ตัวอย่าง: `"Positive or neutral view of the world, little to no violence, non-sexual love, and no sexual content."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `MA` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"NR"`)
    - `meaning` — string —  (ตัวอย่าง: `"All audiences."`)
    - `order` — integer —  (ตัวอย่าง: `0`)
  - `GR` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"K"`)
  ...
  - `IL` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"E"`)
    - `meaning` — string —  (ตัวอย่าง: `"Exempt from classification. This rating is usually applied to live broadcasts."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `TW` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"0+"`)
    - `meaning` — string —  (ตัวอย่าง: `"Suitable for watching by general audiences."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `ZA` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"All"`)
    - `meaning` — string —  (ตัวอย่าง: `"This is a programme/film that does not contain any obscenity, and is suitable for family viewing. A logo must be displayed in the corner of the screen for 30 seconds after each commercial break."`)
    - `order` — integer —  (ตัวอย่าง: `1`)
  - `SG` — array — 
    - `[]` — array items: — 
    - `certification` — string —  (ตัวอย่าง: `"G"`)
