...
|---|---|---|---|---|
| `time_window` | path | string | ใช่ | - |
| `language` | query | string | ไม่ | `ISO-639-1`-`ISO-3166-1` code |
#### Response 200
...
- `results` — array — 
  ...
  - `genre_ids` — array — 
  - `popularity` — number —  (ตัวอย่าง: `609.941`)
  - `release_date` — string —  (ตัวอย่าง: `"2023-03-08"`)
  - `video` — boolean —  (ตัวอย่าง: `false`)
  - `vote_average` — number —  (ตัวอย่าง: `7.374`)
  - `vote_count` — integer —  (ตัวอย่าง: `684`)
- `total_pages` — integer —  (ตัวอย่าง: `1000`)
- `total_results` — integer —  (ตัวอย่าง: `20000`)
...
```json
{
  ...
  "results": [
    ...
    },
    {
      ...
      "gender": 2,
      "known_for_department": "Acting",
      "profile_path": "/qPGmIuQ3DKzzpZy5Y12WeoOUijV.jpg",
      "known_for": [
        {
          "adult": false,
          "backdrop_path": "/z8eKIdNRbTmCLpFoZqTQvN4wdEM.jpg",
          "id": 9470,
    ...
    },
    {
      ...
      "gender": 1,
      "known_for_department": "Acting",
      "profile_path": "/4ot6zcXkhYoDkwPk5B6534U03kB.jpg",
      "known_for": [
        {
          "adult": false,
    ...
    },
    {
      ...
      "gender": 2,
      "known_for_department": "Acting",
      "profile_path": "/okP7SeXKP3tw9Y3YTVWLIZAMdm8.jpg",
      "known_for": [
        {
          "adult": false,
      ...
      "known_for": [
        {
          ...
          "poster_path": "/dULtPHV0A6Hfwr4hVfcAFoTsIFo.jpg",
          "media_type": "movie",
          "genre_ids": [
            28,
            878
    ...
    },
    {
      ...
      "known_for": [
        ...
        {
          "adult": false,
          "backdrop_path": "/ldl3MkGTyom9618e65oKvXSF1lC.jpg",
          "id": 101299,
    ...
    },
    {
      ...
      "original_name": "Eadweard Muybridge",
      "media_type": "person",
      "popularity": 3.175,
      "gender": 2,
      "known_for_department": "Acting",
      "profile_path": "/idESyuc7NbHnKRDvSWXgOVBxtQU.jpg",
      "known_for": [
        {
          "adult": false,
          "backdrop_path": null,
          ...
          "original_language": "en",
          "original_title": "Eadweard Muybridge, Zoopraxographer",
          "overview": "Thom Andersen's remarkable and sadly neglected hour-long documentary adroitly combines biography, history, film theory, and philosophical reflection. Muybridge's photographic studies of animal locomotion in the 1870s were a major forerunner of movies; even more interesting are his subsequent studies of diverse people, photographed against neutral backgrounds.",
          "poster_path": "/aheet9nDJ6FWrXlRj50c18mMZCB.jpg",
          "media_type": "movie",
          "genre_ids": [
            99
          ],
          "popularity": 2.296,
          "release_date": "1975-09-28",
          "video": false,
          "vote_average": 7.067,
          "vote_count": 15
        }
    ...
    },
    {
      ...
      "gender": 2,
      "known_for_department": "Acting",
      "profile_path": "/u525jeDOzg9hVdvYfeehTGnw7Aa.jpg",
      "known_for": [
        {
          "adult": false,
    ...
    },
    {
      ...
      "known_for": [
        ...
        {
          "adult": false,
          "backdrop_path": "/ipjZVitWMjrVd2hoWKU2waVdxGy.jpg",
          "id": 254128,
          "title": "San Andreas",
          "original_language": "en",
    ...
    },
    {
      ...
      "gender": 2,
      "known_for_department": "Acting",
      "profile_path": "/a56s3RxYTVXoS9csmaB5Zm5b4Xq.jpg",
      "known_for": [
        {
          "adult": false,
    ...
    },
    {
      ...
      "profile_path": "/dKlaXJk3NLcsC1CKMx6xmyW5BZD.jpg",
      "known_for": [
        {
          "adult": false,
          ...
          "poster_path": "/wlTHU4M3Hmkxntnfv4iVMeMnPg2.jpg",
          "media_type": "movie",
          "genre_ids": [
            18,
            27,
        ...
        {
          "adult": false,
          "backdrop_path": "/tilClWjFZeUTGJu0pxgF72fvUmN.jpg",
          "id": 99,
          ...
          "poster_path": "/hjQhzhkGYXPNM96k0mOgob6HMmn.jpg",
          "media_type": "movie",
          "genre_ids": [
            35,
            18
        ...
        {
          "adult": false,
          "backdrop_path": "/vxTFLjaAiirocGfiXWPE9tQFchI.jpg",
          "id": 519010,
...
- `results` — array — 
  ...
  - `original_name` — string —  (ตัวอย่าง: `"Ana de Armas"`)
  - `media_type` — string —  (ตัวอย่าง: `"person"`)
  - `popularity` — number —  (ตัวอย่าง: `349.766`)
  ...
  - `known_for` — array — 
    ...
    - `media_type` — string —  (ตัวอย่าง: `"movie"`)
    - `genre_ids` — array — 
    - `popularity` — number —  (ตัวอย่าง: `79.571`)
    - `release_date` — string —  (ตัวอย่าง: `"2017-10-04"`)
    - `video` — boolean —  (ตัวอย่าง: `false`)
    - `vote_average` — number —  (ตัวอย่าง: `7.531`)
...
- `results` — array — 
  - `[]` — array items: — 
  - `adult` — boolean —  (ตัวอย่าง: `false`)
  - `backdrop_path` — string —  (ตัวอย่าง: `"/8P15FsYcTwQZ4G5rRMd1TKD14Aq.jpg"`)
  - `id` — integer —  (ตัวอย่าง: `103768`)
  - `name` — string —  (ตัวอย่าง: `"Sweet Tooth"`)
  - `original_language` — string —  (ตัวอย่าง: `"en"`)
  - `original_name` — string —  (ตัวอย่าง: `"Sweet Tooth"`)
  - `overview` — string —  (ตัวอย่าง: `"On a perilous adventure across a post-apocalyptic world, a lovable boy who's half-human and half-deer searches for a new beginning with a gruff protector."`)
  - `poster_path` — string —  (ตัวอย่าง: `"/dBxxtfhC4vYrxB2fLsSxOTY2dQc.jpg"`)
  - `media_type` — string —  (ตัวอย่าง: `"tv"`)
  - `genre_ids` — array — 
  - `popularity` — number —  (ตัวอย่าง: `137.498`)
  - `first_air_date` — string —  (ตัวอย่าง: `"2021-06-04"`)
  - `vote_average` — number —  (ตัวอย่าง: `7.928`)
  - `vote_count` — integer —  (ตัวอย่าง: `1094`)
