...
|---|---|---|---|---|
| `collection_id` | path | integer | ใช่ | - |
...
- `original_name` — string —  (ตัวอย่าง: `"Star Wars Collection"`)
- `overview` — string —  (ตัวอย่าง: `"An epic space-opera theatrical film series, which depicts the adventures of various characters \"a long time ago in a galaxy far, far away….\""`)
- `poster_path` — string —  (ตัวอย่าง: `"/22dj38IckjzEEUZwN1tPU5VJ1qq.jpg"`)
- `backdrop_path` — string —  (ตัวอย่าง: `"/4z9ijhgEthfRHShoOvMaBlpciXS.jpg"`)
- `parts` — array — 
  - `[]` — array items: — 
  - `adult` — boolean —  (ตัวอย่าง: `false`)
  - `backdrop_path` — string —  (ตัวอย่าง: `"/2w4xG178RpB4MDAIfTkqAuSJzec.jpg"`)
  - `id` — integer —  (ตัวอย่าง: `11`)
  - `name` — string —  (ตัวอย่าง: `"Star Wars"`)
  - `original_name` — string —  (ตัวอย่าง: `"Star Wars"`)
  ...
  - `original_language` — string —  (ตัวอย่าง: `"en"`)
  - `genre_ids` — array — 
  - `popularity` — number —  (ตัวอย่าง: `15.8557`)
  - `release_date` — string —  (ตัวอย่าง: `"1977-05-25"`)
  - `video` — boolean —  (ตัวอย่าง: `false`)
  - `vote_average` — number —  (ตัวอย่าง: `8.205`)
  - `vote_count` — integer —  (ตัวอย่าง: `21522`)
...
- `backdrops` — array — 
  ...
  - `iso_639_1` — object — 
  - `file_path` — string —  (ตัวอย่าง: `"/d8duYyyC9J5T825Hg7grmaabfxQ.jpg"`)
  - `vote_average` — number —  (ตัวอย่าง: `5.464`)
  - `vote_count` — integer —  (ตัวอย่าง: `30`)
  - `width` — integer —  (ตัวอย่าง: `1920`)
- `posters` — array — 
  - `[]` — array items: — 
  - `aspect_ratio` — number —  (ตัวอย่าง: `0.667`)
  - `height` — integer —  (ตัวอย่าง: `3000`)
  - `iso_639_1` — string —  (ตัวอย่าง: `"en"`)
  - `file_path` — string —  (ตัวอย่าง: `"/r8Ph5MYXL04Qzu4QBbq2KjqwtkQ.jpg"`)
  - `vote_average` — number —  (ตัวอย่าง: `5.516`)
  - `vote_count` — integer —  (ตัวอย่าง: `14`)
  - `width` — integer —  (ตัวอย่าง: `2000`)
