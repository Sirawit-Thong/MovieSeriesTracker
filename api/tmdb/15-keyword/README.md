...
- `id` — integer —  (ตัวอย่าง: `1701`)
- `name` — string —  (ตัวอย่าง: `"hero"`)
...
```json
{
  ...
  "results": [
    ...
    },
    {
      ...
      "popularity": 931.513,
      "poster_path": "/vo9QISNKYtDN40VKfQkPxbMOO9j.jpg",
    ...
    },
    {
      ...
      "overview": "Thor schließt sich nach den Geschehnissen von Endgame den Guardians an & schickt sich an, als neues Team-Mitglied neue Weltraumabenteuer zu erleben. Es muss nur vorher noch die Frage des Schiffskapitäns geklärt werden…",
      "popularity": 647.851,
      "poster_path": "/72Rz9HSQWnPqwpa3qJzgiZ6WHh.jpg",
    ...
    },
    {
      ...
      "overview": "Venom und sein Wirt Eddie Brock bekommen es mit dem Serienkiller Cletus Kasady zu tun, der sich in den blutrünstigen Carnage verwandelt, nachdem er ebenfalls mit einem Symbiont in Kontakt gekommen ist.",
      "popularity": 186.67,
      "poster_path": "/ztoy8TiHu9qa22bW1DkhdNIzeF9.jpg",
    ...
    {
      "adult": false,
      "backdrop_path": "/9lL3VVktfy8ny774XP00tJHXGvP.jpg",
      "genre_ids": [
        878,
        28,
        12
      ...
      "overview": "",
      "popularity": 153.407,
      "poster_path": "/1um4RgzHQ5r0pKPrQryPmqwk1iS.jpg",
    ...
    },
    {
      ...
      "overview": "Dreißig Jahre nachdem der weise und mächtige Zordon die Mighty Morphin Power Rangers gegründet hat, sieht sich das Team einer vertrauten Bedrohung aus der Vergangenheit gegenüber. Mitten in einer globalen Krise werden sie erneut aufgefordert, die Helden zu sein, die die Welt braucht.",
      "popularity": 130.019,
    ...
    {
      "adult": false,
      "backdrop_path": "/skauHPLA4so9PqOuu3jhWmiWnFd.jpg",
      "genre_ids": [
        28,
        12,
        14
    ...
    {
      "adult": false,
      "backdrop_path": "/gWuiOPAz3WImzFZUzHTT6c4omrD.jpg",
      "genre_ids": [
        878,
        28,
        12,
    ...
    },
    {
      ...
      "popularity": 91.783,
      "poster_path": "/uC7YwWcXusYgpWHSxl6njJDiFfk.jpg",
    ...
    },
    {
      ...
      "overview": "Ein Terroristenkult versucht mittels Giftgas, alle Menschen mit angeborenen Spezialitäten auf der ganzen Welt zu vernichten. Nachdem bereits die erste Stadt verwüstet ist, werden die Helden ausgesandt, um den Anführer des Kultes festzusetzen. Deku, Bakugo und Shoto reisen als Teil des Teams von Endeavor nach Otheon in Europa. Doch dort haben sie aber zunächst weniger mit dem Kult, sondern erst einmal mit der Polizei und der Anklage, 12 Menschen getötet zu haben, zu kämpfen …",
      "popularity": 80.103,
      "poster_path": "/kiVhYqu2FKNJNlFaUTN0UTQqKu7.jpg",
...
- `results` — array — 
  ...
  - `backdrop_path` — string —  (ตัวอย่าง: `"/3CxUndGhUcZdt1Zggjdb2HkLLQX.jpg"`)
  - `genre_ids` — array — 
  ...
  - `vote_count` — integer —  (ตัวอย่าง: `2079`)
- `total_pages` — integer —  (ตัวอย่าง: `11`)
- `total_results` — integer —  (ตัวอย่าง: `211`)
