...
|---|---|---|---|---|
| `list_id` | path | integer | ใช่ | - |
| `language` | query | string | ไม่ | - |
| `movie_id` | query | integer | ไม่ | - |
#### Response 200
...
- `item_present` — boolean —  (ตัวอย่าง: `true`)
...
```json
{
  ...
  "items": [
    ...
    },
    {
      ...
      "overview": "Nachdem sie das Sokovia-Abkommen abgelehnt und Steve Rogers zur Flucht verholfen hat, befindet sich Natasha Romanoff auf der Flucht. Von der Regierung gejagt, führt sie ihr Weg nach Russland, wo sie auf alte Verbündete und neue Feinde trifft.",
      "popularity": 107.622,
      "poster_path": "/gkyoYo9d6g98xjScnZwh3nL2Yfp.jpg",
    ...
    },
    {
      ...
      "overview": "Scott Lang hadert  mit den Konsequenzen seiner Taten als Superheld und Vater. Auf Drängen von Hope van Dyne (alias Wasp) und Dr. Hank Pym schlüpft er erneut in die Rolle des Ant-Mans und taucht in die Quantenwelt ein, um eine sehr gefährliche Rettungsmission gegen die Zeit und jede Chance auf Erfolg durchzuführen.",
      "popularity": 79.021,
      "poster_path": "/41imUCjSKoBjPUrfeCqib8KAvHS.jpg",
    ...
    },
    {
      ...
      "popularity": 88.127,
      "poster_path": "/8etFULS6CRN39vvXykQH1mUD1yB.jpg",
    ...
    },
    {
      ...
      "overview": "In naher Zukunft schützt ein abgekämpfter Logan einen gebrochenen Professor X in einem Versteck nahe der mexikanischen Grenze. Doch Logans Versuche, sich vor der Welt und seinem Vermächtnis zu verstecken, misslingen, als ein junger Mutant, von dunklen Kräften verfolgt, bei ihnen Zuflucht sucht.",
      "popularity": 65.289,
      "poster_path": "/y4KWNN6ROnKaefdTFdu5kKMVN59.jpg",
    ...
    },
    {
      ...
      "overview": "Um seinem sicheren Tod durch Krebs zu entkommen, willigt Wade Wilson in ein riskantes Experiment ein, das ihn heilen und in einen Supersöldner verwandeln soll. Doch den Preis für sein Überleben bezahlt Wilson am Ende mit schweren Qualen und körperlicher Entstellung. Getrieben von Rache und durch Selbstheilungskräfte nahezu unsterblich geworden, jagt Wilson nun als Mutant Deadpool seine Peiniger und gefährdet damit seine große Liebe Vanessa, die er nach seiner Verwandlung voller Scham aus seinem Leben verbannte.",
      "popularity": 104.34,
      "poster_path": "/VEfCqkbK062Egob26rYQWAJoE7.jpg",
    ...
    },
    {
      ...
      "popularity": 47,
      "poster_path": "/ngp9dkVaTPWUCbeP2gbaYkfucGW.jpg",
    ...
    {
      "adult": false,
      "backdrop_path": "/mVnqWRyC7Qkg7eyLkko8aYBDxb8.jpg",
      "genre_ids": [
        28,
        12,
        14
    ...
    },
    {
      ...
      "overview": "Bei seinem letzten Undercovereinsatz als FBI-Special-Agent läuft es schlecht für Frank Castle, denn versehentlich wird ein junger Mann dabei getötet. Leider handelt es sich dabei um den Sohn des wohlhabenden Howard Saint, der dem Verantwortlichen daraufhin Rache schwört, denn hinter Saints Fassade lauert ein Magnat des Verbrechens. Dem beauftragten Killertrupp fällt dann auch Castles komplette Familie zum Opfer, er selbst überlebt schwer verletzt. Von dem Wunsch nach Vergeltung getrieben und mit schwerer Artillerie bewaffnet nimmt er die Tarnexistenz des \"Punisher\" an und beginnt, die Verantwortlichen aufzuspüren und auszulöschen, während er sich als Mensch schwertut, in menschliche Gesellschaft wieder hineinzuwachsen ...",
      "popularity": 34.361,
      "poster_path": "/1OmVvrwpGqQWyYlASshTlboBdTU.jpg",
    ...
    },
    {
      ...
      "overview": "Der ultimative Vampirjäger, Blade, hat die Kräfte eines Unsterblichen, die Seele eines Menschen und das Herz eines Helden. Es ist seine Aufgabe, mit Hilfe seiner Stärken und seiner Waffen die menschliche Rasse vor der Auslöschung zu bewahren. Denn ihnen wurde vom Anführer der blutdurstigen Vampire, Deacon Frost, der Krieg erklärt. Frost glaubt, durch einen langen vergessenen Fluch die Erde buchstäblich in die Hölle verwandeln zu können. Blade und sein Mentor Whistler haben alle Hände voll zu tun, um Frost bei seinem Vorhaben aufzuhalten.",
      "popularity": 41.748,
      "poster_path": "/tUC8Rfv3GSf7ks35yLqwaYY2gut.jpg",
...
- `created_by` — string —  (ตัวอย่าง: `"travisbell"`)
- `description` — string —  (ตัวอย่าง: `"The idea behind this list is to collect the live action comic book movies from within the Marvel franchise."`)
- `favorite_count` — integer —  (ตัวอย่าง: `0`)
- `id` — string —  (ตัวอย่าง: `"1"`)
- `items` — array — 
  - `[]` — array items: — 
  - `adult` — boolean —  (ตัวอย่าง: `false`)
  - `backdrop_path` — string —  (ตัวอย่าง: `"/14QbnygCuTO0vl7CAFmPf1fgZfV.jpg"`)
  - `genre_ids` — array — 
  - `id` — integer —  (ตัวอย่าง: `634649`)
  - `media_type` — string —  (ตัวอย่าง: `"movie"`)
  - `original_language` — string —  (ตัวอย่าง: `"en"`)
  - `original_title` — string —  (ตัวอย่าง: `"Spider-Man: No Way Home"`)
  - `overview` — string —  (ตัวอย่าง: `"Peter Parker ist demaskiert und kann sein normales Leben nicht mehr von den hohen Einsätzen als Superheld trennen. Als er Doctor Strange um Hilfe bittet, wird die Lage noch gefährlicher und er muss entdecken, was es wirklich bedeutet, Spider-Man zu sein."`)
  - `popularity` — number —  (ตัวอย่าง: `398.217`)
  - `poster_path` — string —  (ตัวอย่าง: `"/iNKf4D0AzOj9GLq8ZyG3WZaqibL.jpg"`)
  - `release_date` — string —  (ตัวอย่าง: `"2021-12-15"`)
  - `title` — string —  (ตัวอย่าง: `"Spider-Man: No Way Home"`)
  - `video` — boolean —  (ตัวอย่าง: `false`)
  - `vote_average` — integer —  (ตัวอย่าง: `8`)
  - `vote_count` — integer —  (ตัวอย่าง: `17267`)
- `item_count` — integer —  (ตัวอย่าง: `59`)
- `iso_639_1` — string —  (ตัวอย่าง: `"en"`)
- `name` — string —  (ตัวอย่าง: `"The Marvel Universe"`)
- `poster_path` — string —  (ตัวอย่าง: `"/coJVIUEOToAEGViuhclM7pXC75R.jpg"`)
