# Watch Providers API (ผู้ให้บริการรับชม)
...
- `results` — array — 
  - `[]` — array items: — 
  - `iso_3166_1` — string —  (ตัวอย่าง: `"AD"`)
  - `english_name` — string —  (ตัวอย่าง: `"Andorra"`)
  - `native_name` — string —  (ตัวอย่าง: `"Andorra"`)

---

### `GET /3/watch/providers/movie`

> สรุป: Movie Providers
...
- `results` — array — 
  ...
  - `display_priorities` — object — 
    - `CA` — integer —  (ตัวอย่าง: `6`)
    - `AE` — integer —  (ตัวอย่าง: `1`)
    - `AR` — integer —  (ตัวอย่าง: `3`)
    - `AT` — integer —  (ตัวอย่าง: `4`)
    - `AU` — integer —  (ตัวอย่าง: `10`)
    - `BE` — integer —  (ตัวอย่าง: `6`)
    - `BO` — integer —  (ตัวอย่าง: `6`)
    - `BR` — integer —  (ตัวอย่าง: `8`)
    - `BG` — integer —  (ตัวอย่าง: `2`)
    - `CH` — integer —  (ตัวอย่าง: `4`)
    - `CL` — integer —  (ตัวอย่าง: `3`)
    - `CO` — integer —  (ตัวอย่าง: `4`)
    - `CR` — integer —  (ตัวอย่าง: `5`)
    - `CZ` — integer —  (ตัวอย่าง: `3`)
    - `DE` — integer —  (ตัวอย่าง: `4`)
    - `DK` — integer —  (ตัวอย่าง: `7`)
    - `EC` — integer —  (ตัวอย่าง: `7`)
    - `EE` — integer —  (ตัวอย่าง: `3`)
    - `EG` — integer —  (ตัวอย่าง: `2`)
    - `ES` — integer —  (ตัวอย่าง: `4`)
    - `FI` — integer —  (ตัวอย่าง: `10`)
    - `FR` — integer —  (ตัวอย่าง: `5`)
    - `GB` — integer —  (ตัวอย่าง: `5`)
    - `GR` — integer —  (ตัวอย่าง: `2`)
    - `GT` — integer —  (ตัวอย่าง: `7`)
    - `HK` — integer —  (ตัวอย่าง: `5`)
    - `HN` — integer —  (ตัวอย่าง: `7`)
    - `HU` — integer —  (ตัวอย่าง: `3`)
    - `ID` — integer —  (ตัวอย่าง: `4`)
    - `IE` — integer —  (ตัวอย่าง: `4`)
    - `IN` — integer —  (ตัวอย่าง: `8`)
    - `IT` — integer —  (ตัวอย่าง: `4`)
    - `JP` — integer —  (ตัวอย่าง: `7`)
    - `LT` — integer —  (ตัวอย่าง: `3`)
    - `LV` — integer —  (ตัวอย่าง: `3`)
    - `MX` — integer —  (ตัวอย่าง: `4`)
    - `MY` — integer —  (ตัวอย่าง: `4`)
    - `NL` — integer —  (ตัวอย่าง: `8`)
    - `NO` — integer —  (ตัวอย่าง: `6`)
    - `NZ` — integer —  (ตัวอย่าง: `4`)
    - `PE` — integer —  (ตัวอย่าง: `3`)
    - `PH` — integer —  (ตัวอย่าง: `4`)
    - `PL` — integer —  (ตัวอย่าง: `1`)
    - `PT` — integer —  (ตัวอย่าง: `4`)
    - `PY` — integer —  (ตัวอย่าง: `7`)
    - `RU` — integer —  (ตัวอย่าง: `2`)
    - `SA` — integer —  (ตัวอย่าง: `1`)
    - `SE` — integer —  (ตัวอย่าง: `8`)
    - `SG` — integer —  (ตัวอย่าง: `5`)
    - `SK` — integer —  (ตัวอย่าง: `3`)
    - `TH` — integer —  (ตัวอย่าง: `4`)
    - `TR` — integer —  (ตัวอย่าง: `6`)
    - `TW` — integer —  (ตัวอย่าง: `7`)
    - `US` — integer —  (ตัวอย่าง: `4`)
    - `VE` — integer —  (ตัวอย่าง: `4`)
    - `ZA` — integer —  (ตัวอย่าง: `2`)
    - `SI` — integer —  (ตัวอย่าง: `31`)
    - `CV` — integer —  (ตัวอย่าง: `13`)
    - `GH` — integer —  (ตัวอย่าง: `17`)
    - `MU` — integer —  (ตัวอย่าง: `15`)
    - `MZ` — integer —  (ตัวอย่าง: `16`)
    - `UG` — integer —  (ตัวอย่าง: `16`)
    - `IL` — integer —  (ตัวอย่าง: `28`)
  - `display_priority` — integer —  (ตัวอย่าง: `2`)
  - `logo_path` — string —  (ตัวอย่าง: `"/peURlLlr8jggOwK53fJ5wdQl05y.jpg"`)
  - `provider_name` — string —  (ตัวอย่าง: `"Apple TV"`)
  - `provider_id` — integer —  (ตัวอย่าง: `2`)
...
```json
{
  "results": [
    ...
    },
    {
      ...
      "display_priority": 60,
      "logo_path": "/3boZfmOm36QssW1VllChtZL6P50.jpg",
      "provider_name": "Salto Amazon Channel",
      "provider_id": 1731
    },
    {
      "display_priorities": {
