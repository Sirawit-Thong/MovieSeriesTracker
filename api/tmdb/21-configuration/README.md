...
- `images` — object — 
  - `base_url` — string —  (ตัวอย่าง: `"http://image.tmdb.org/t/p/"`)
  - `secure_base_url` — string —  (ตัวอย่าง: `"https://image.tmdb.org/t/p/"`)
...
- `iso_639_1` — string —  (ตัวอย่าง: `"bi"`)
- `english_name` — string —  (ตัวอย่าง: `"Bislama"`)
