...
export type LanguageWhereInput = {
  ...
  iso6391?: Prisma.StringFilter<"Language"> | string
  englishName?: Prisma.StringFilter<"Language"> | string
...
export type LanguageScalarWhereWithAggregatesInput = {
  ...
  iso6391?: Prisma.StringWithAggregatesFilter<"Language"> | string
  englishName?: Prisma.StringWithAggregatesFilter<"Language"> | string
...
export type LanguageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"iso6391" | "englishName" | "name", ExtArgs["result"]["language"]>
...
export interface LanguageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `iso6391`
   * const languageWithIso6391Only = await prisma.language.findMany({ select: { iso6391: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Languages and only return the `iso6391`
   * const languageWithIso6391Only = await prisma.language.createManyAndReturn({
   *   select: { iso6391: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Languages and only return the `iso6391`
   * const languageWithIso6391Only = await prisma.language.updateManyAndReturn({
   *   select: { iso6391: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface LanguageFieldRefs {
  readonly iso6391: Prisma.FieldRef<"Language", 'String'>
  readonly englishName: Prisma.FieldRef<"Language", 'String'>
